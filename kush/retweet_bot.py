...
relevant_accounts = ['CECHR_UoD', 'Ecosia', 'FairWork_Nu', 'Meerwind_HLMMR',
                     'trustedclothes', 'Essenza_Bio', 'CFADC',
                     'Groenemusketier', 'ethicalbrandz', 'wearetheninety9',
                     'FAIRTRADE', 'hackandcraft', 'fairtrade_india',
                     'ECOCENT_NL', 'EnergieOverheid', 'GroeneCourant',
                     'TrouwGroen', 'bnrduurzaam', 'DuurzaamNieuws',
                     'DuurzaamBV', 'NatGeoPhotos', 'SpaceX', 'NatGeo', 'NASA',
                     ]
