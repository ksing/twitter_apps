...
desirable_words = ['ethical', 'duurza', 'organic', 'biologisch',
                   'climate change' 'fairtrade', 'sustainab',
                   'fairfashion', 'recycl', 'upcycl', 'plastic']
...
for new_follower in current_followers - followers_list:
    ...
    if not user.following and \
            any(desirable_words in word for word in user.description().lower()):
        user.follow()
